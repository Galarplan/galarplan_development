    ...
    def action_contact_create_validate(self):
        ...
        for employee in self:
            ...
            partner_vals = {
                ...
                "company_id":False,
                'l10n_latam_identification_type_id': employee.l10n_latam_identification_type_id and employee.l10n_latam_identification_type_id.id or False,
                "company_type": "person",
                'is_customer': True,
                'is_supplier': True,
            ...
            bank_partner_vals = {
                ...
                'l10n_latam_identification_tercero_id': employee.l10n_latam_identification_tercero_id and employee.l10n_latam_identification_tercero_id.id or False,
            ...
            if partner:
                ...
                #######################
                bank_partner_vals["partner_id"] = partner.id#"2205626142"
                ...
                if not brw_partner_bank:
                    ...
                    brw_partner_bank.write(bank_partner_vals)
                employee._write({
