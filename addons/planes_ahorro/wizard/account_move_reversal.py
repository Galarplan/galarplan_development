            ...
            if values.get("res_model","")=="account.move":
                if "res_id" in values:
                    ...
                    if brw_move.move_type in ('out_refund','in_refund') and brw_move.state=='draft':
                        ...
                        if brw_move.reversed_entry_id.saving_line_id:
                            brw_move.saving_line_id=brw_move.reversed_entry_id.saving_line_id
                            brw_move.saving_id = brw_move.reversed_entry_id.saving_id
                else:
